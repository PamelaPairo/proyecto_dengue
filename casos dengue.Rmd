...
Prueba <- Prueba %>% mutate(Departamento = case_when(
    ...
    str_detect(Departamento, regex("^Jos", ignore_case = TRUE)) ~ "Jose C. Paz",
...
bind_rows(list(buenos_aires, caba, catamarca, chaco, cordoba, corrientes, entre_rios, formosa, jujuy, la_pampa, la_rioja, mendoza, misiones, salta, san_juan, san_luis, santa_fe, santiago_del_estero))
```
